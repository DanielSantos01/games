...
class Button():
    ...
    def __init__(self, game_settings, screen, message):
        ...
        self.font = pygame.font.SysFont(None, 48)                                             #define a fonte padrão (None) e com tamanho 48

        #constrói o objeto rect do botão e o centraliza
        self.rect = pygame.Rect(0, 0, self.width, self.heigth)                                #cria o rect do botão
        self.rect.centerx = self.screen_rect.centerx                                          #define o centro do botão como o centro da tela
    ...
    def prep_msg(self, message):
        ...
        self.msg_image = self.font.render(message, True, self.text_color, self.button_color) #transforma a string em uma imagem renderizada
        self.msg_image_rect = self.msg_image.get_rect()                                      #obtém o rect da imagem criada
        self.msg_image_rect.center = self.rect.center                                        #transforma o centro da msg no centro do botão
